...
def get_tracks():
    ...
    for string in soup.stripped_strings:
        # if (re.search('\D\d\d\D\d\d\D\d\d\D', str(string))):  # or ("..." in str(o)):
        #     d[today+"_"+string.replace("'","")] = [next(soup.stripped_strings,""), next(soup.stripped_strings,"")]
        # print(string)
        d.setdefault('song_time', []).append(string)
